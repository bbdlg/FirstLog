 ...
 */       
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	...
    	menu.add(Menu.NONE, Menu.FIRST + 2, 2, "上传本地数据到云端").setIcon(android.R.drawable.ic_menu_delete);
    	menu.add(Menu.NONE, Menu.FIRST + 3, 3, "下载云端数据到本地").setIcon(android.R.drawable.ic_menu_call);
